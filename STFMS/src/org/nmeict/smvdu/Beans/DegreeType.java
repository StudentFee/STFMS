...
public class DegreeType  implements java.io.Serializable {
	...
	public List<DegreeType> getLoadAllDegreeType() {
		loadAllDegreeType = getiDegreeType().allDegreeType();
		for(DegreeType dt : loadAllDegreeType)
		{
			System.out.println("Name : "+dt.getDegreeName());
		}
	...
	public SelectItem[] getItems() {
		List<DegreeType> sesionCode = getiDegreeType().allDegreeType();
	...
	public void update()
	{
		...
		//System.out.println("Code : "+this.getExamCodeSetUps());
